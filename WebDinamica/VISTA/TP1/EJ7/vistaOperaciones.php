...
<form id="operaciones" name="operaciones" method="get" action="../../ACCION/formAccion.php">
    ...
    <input type="number" id="operando1" name="operando1" class="form-action">
    ...
    <input type="number" id="operando2" name="operando2" class="form-action">
    <input type="submit" name="submit" value="Operar" class="btn btn-success">
</form>
