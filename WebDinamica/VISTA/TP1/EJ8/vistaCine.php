...
<form id="calculoPrecio" name="calculoPrecio" method="get" action="../../ACCION/formAccion.php">
    ...
    <input type="radio" id="menorDoce" name="edad" value="menorDoce">
    <label for="menorDoce">Menor de 12</label> <br>
    <input type="radio" id="mayorDoce" name="edad" value="mayorDoce">
    <label for="mayorDoce" name="edad">Mayor de 12</label> <br>
    <p>Es estudiante: </p>
    <div id="errorEstudios"></div>
    <input type="radio" id="estudiante" name="estudios" value="estudiante">
    <label for="estudiante">Estudiante</label> <br>
    <input type="radio" id="noEstudiante" name="estudios" value="noEstudiante">
